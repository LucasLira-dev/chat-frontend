...
export const SocialButton = ({ provider }: SocialButtonProps) => {
    ...
    return (
        <div className="rounded-lg bg-white border border-black-20 hover:border-primary transition-colors">
            <button className=" flex items-center justify-center text-foreground/50 hover:text-foreground transition-colors px-8 py-4 cursor-pointer" onClick={handleSubmit}>
                {
                    loading ? (
